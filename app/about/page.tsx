    ...
    <div className="th-bg min-h-screen pt-24">
      ...
      >
        ...
        <div className="relative z-10 text-center px-6">
          <p className="text-[9px] tracking-[0.65em] text-[#c4a97d] uppercase mb-5 anim-fade-up">
            Our Story
          </p>
          <h1
            className="text-5xl sm:text-6xl md:text-7xl font-light text-[#e8e0d4] leading-tight anim-fade-up anim-d1"
      ...
      {/* Brand story */}
      <section className="max-w-3xl mx-auto px-6 py-24 border-b border-[rgba(196,169,125,0.1)]">
        <p className="text-[9px] tracking-[0.55em] text-[#c4a97d] uppercase mb-8">The Beginning</p>
        <p
        ...
        <p className="text-sm leading-loose text-[#8a8076] mb-6">
        ...
        <p className="text-sm leading-loose text-[#8a8076]">
      ...
      <section className="max-w-7xl mx-auto px-6 lg:px-12 py-24 border-b border-[rgba(196,169,125,0.1)]">
        <p className="text-[9px] tracking-[0.55em] text-[#c4a97d] uppercase text-center mb-16">What We Stand For</p>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          {[
            ...
            <div key={item.title} className="border-t border-[rgba(196,169,125,0.15)] pt-8">
              <h3
